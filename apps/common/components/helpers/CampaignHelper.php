...
class CampaignHelper
{
    ...
    public static function getParsedFieldValueByListFieldValueTagInfo()
    {
        return Yii::app()->hooks->applyFilters('common_helper_parsed_field_value_by_list_field_value_tag_info', array(
	        ...
	        '[CAMPAIGN_NAME]'   => Yii::t('campaigns', 'Set the current campaign name for which this action is taken'),
            '[CAMPAIGN_UID]'    => Yii::t('campaigns', 'Set the current campaign unique id for which this action is taken'),
        ));
    }
    ...
    public static function getParsedFieldValueByListFieldValue(CAttributeCollection $collection)
    {
        ...
        $searchReplace = (array)Yii::app()->hooks->applyFilters('common_helper_parsed_field_value_by_list_field_value_search_replace', $searchReplace, $collection);

...
class EmailTemplateBuilderExt extends ExtensionInit
{
    ...
    public function registerAssets()
    {
        ...
        Yii::app()->clientScript->registerCssFile($assetsUrl . '/static/css/main.c87ec30c.css');
        Yii::app()->clientScript->registerCssFile($assetsUrl . '/static/css/code-editor.css');
        Yii::app()->clientScript->registerScriptFile($assetsUrl . '/static/js/main.ae3c025e.js');

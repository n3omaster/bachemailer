    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary borderless">
            ...
            <div class="box-body">
                ...
                <div class="box-header">
                    <div class="pull-left">
                        <h3 class="box-title"><?php echo Yii::t('ext_recaptcha', 'Additional domains and key pairs');?></h3>
                    </div>
                    <div class="pull-right">
		                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                          ->add(HtmlHelper::accessLink(IconHelper::make('create'), 'javascript:;', array('class' => 'btn btn-primary btn-flat btn-add-domains-keys-pair', 'title' => Yii::t('app', 'Create new'))))
                          ->render();
		                ?>
                    </div>
                ...
                <div class="box-body domains-keys-pair-items">
                    <?php foreach ($model->domains_keys_pair as $index => $pair) {
	                    $this->renderPartial('_domains-keys-pair-template', array(
		                    'form'              => $form,
...
<script type="text/template" id="domains-keys-pair-item-template">
    <?php $this->renderPartial('_domains-keys-pair-template', array( 
        'form'              => $form,    

...
class ListSubscriber extends ActiveRecord
{
	 ...
	 * @return bool
	 */
	public function hasOpenedCampaignById($campaignId)
	{
		$criteria = new CDbCriteria();
     ...
     * @return string
     */
    public function getLastOpenDate($format = 'Y-m-d H:i:s')
    {
        $criteria = new CDbCriteria();
        $criteria->compare('subscriber_id', (int)$this->subscriber_id);
        ...
        return $model ? (string)date($format, strtotime($model->date_added)) : '';
    }
     ...
     * @return string
     */
    public function getLastClickDate($format = 'Y-m-d H:i:s')
    {
        $criteria = new CDbCriteria();
        $criteria->compare('subscriber_id', (int)$this->subscriber_id);
     ...
     * @return string
     */
    public function getLastSendDate($format = 'Y-m-d H:i:s')
    {
        $criteria = new CDbCriteria();
        $criteria->compare('subscriber_id', (int)$this->subscriber_id);
        $criteria->select = 'campaign_id, date_added';

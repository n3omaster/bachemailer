    ...
    */
    public function search()
    {
	    ...
	    if (empty($this->status)) {
		    $criteria->addNotInCondition('t.status', array(self::STATUS_HIDDEN, self::STATUS_PENDING_DELETE));
	    } else {
    ...
    public static function getTypesMapping()
    {
        ...
        $mapping = array(
            ...
            self::TRANSPORT_INBOXROAD_WEB_API    => 'DeliveryServerInboxroadWebApi',
            ...
            self::TRANSPORT_SMTP_PMTA            => 'DeliveryServerSmtpPmta',
            self::TRANSPORT_SMTP_INBOXROAD       => 'DeliveryServerSmtpInboxroad',

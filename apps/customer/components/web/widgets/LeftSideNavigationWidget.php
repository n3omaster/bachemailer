...
class LeftSideNavigationWidget extends CWidget
{
    ...
    public function getMenuItems()
    {
        ...
        $menuItems = array(
            ...
            'campaigns' => array(
                ...
                'items'     => array(
	                ...
	                array('url' => array('campaigns_abuse_complaints/index'), 'label' => Yii::t('app', 'Abuse complaints'), 'active' => strpos($route, 'campaigns_abuse_complaints') === 0),
                ),
            ),
            'templates' => array(
        ...
        if ($customer->getGroupOption('campaigns.show_geo_opens', 'no') != 'yes') {
            unset($menuItems['campaigns']['items'][5]);
        }

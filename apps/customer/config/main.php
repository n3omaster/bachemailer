    ...
    'components' => array(
        ...
        'urlManager' => array(
            'rules' => array(
	            ...
	            array('campaigns_abuse_complaints/<action>', 'pattern' => 'campaigns/abuse-complaints/<action:(\w+)>/*'),
	            array('campaigns_abuse_complaints/<action>', 'pattern' => 'campaigns/abuse-complaints/<action:(\w+)>'),
	            array('campaigns_abuse_complaints/index', 'pattern' => 'campaigns/abuse-complaints'),
                ...
                array('survey_export/index', 'pattern' => 'surveys/<survey_uid:([a-z0-9]+)>/export'),
                array('survey_export/<action>', 'pattern' => 'surveys/<survey_uid:([a-z0-9]+)>/responders/export/<action>'),
